class Admin::PostsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_post.save
        format.html { redirect_to admin_post_url(@admin_post), notice: "Post was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_post.update(admin_post_params)
        format.html { redirect_to admin_post_url(@admin_post), notice: "Post was successfully updated." }
