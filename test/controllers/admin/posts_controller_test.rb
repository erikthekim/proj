...
class Admin::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_post" do
    assert_difference("Admin::Post.count") do
      post admin_posts_url, params: { admin_post: { content: @admin_post.content, name: @admin_post.name, title: @admin_post.title } }
    end
  ...
  test "should update admin_post" do
    patch admin_post_url(@admin_post), params: { admin_post: { content: @admin_post.content, name: @admin_post.name, title: @admin_post.title } }
