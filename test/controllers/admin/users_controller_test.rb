...
class Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference("Admin::User.count") do
      post admin_users_url, params: { admin_user: { bio: @admin_user.bio, name: @admin_user.name, password: @admin_user.password } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { bio: @admin_user.bio, name: @admin_user.name, password: @admin_user.password } }
